...
void	textures_init(t_rays *r, t_game *game)
{
	...
	if (r->tex_n.image)
		...
		tex_error("Error: loading NO_texture_xpm\n");
	...
	if (r->tex_s.image)
		...
		tex_error("Error: loading SO_texture_xpm\n");
	...
	if (r->tex_e.image)
		...
		tex_error("Error: loading EA_texture_xpm\n");
	...
	if (r->tex_w.image)
		...
		tex_error("Error: loading WE_texture_xpm\n");
}
